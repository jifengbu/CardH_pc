...
import dataMapList from '../data-map-list';
    ...
    return function wrapWithDataConnect (WrappedComponent) {
        class ConnectData extends Component {
            ...
            setKeepData (keepData) {
                this.hasKeepData = !!keepData;
                dataMapList.update(this.props.location.pathname, keepData, this.props.CONNECTOR_ID);
            }
            ...
            refresh ({ variables, callback }) {
                const properties = keys(variables);
        ...
        const Connected = connect(
            () => function map (state, props) {
                if (!this.CONNECTOR_ID) {
                    this.CONNECTOR_ID = dataMapList.getConnectorId(props.location.pathname);
                }
                if (!this.CONNECTOR_ID) {
                ...
                return Object.assign(
                    ...
                    dataMapList.getKeepData(props.location.pathname)
                );
            },
